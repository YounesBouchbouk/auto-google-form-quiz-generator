...
export function MainLayout({ children }: IMainLayoutProps) {
  ...
  return (
    <Wrapper>
      <Toaster />
      <Header />
      <div className="min-h-screen w-full flex items-center justify-center bg-gray-50/60">
        <div className="w-3/4 relative min-h-[700px] bg-white rounded-lg  flex flex-col gap-3 items-center justify-center  ">
